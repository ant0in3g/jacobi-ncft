...
% The class file is available from http://http://conferenceseries.iop.org/content/authors
...
\ead{gere@dima.unige.it, jean-christophe.wallet@th.u-psud.fr}

%\Keywords{Noncommutative Geometry; non-compact spectral triples; spectral distance; Moyal plan

%\Classification{58B34, 46L52, 81T75} 
...
\bibitem{mdv1} M. Dubois-Violette, R. Kerner, J. Madore,''{\it{Noncommutative differential geometry of matrix
...
\bibitem{gm90} J. Madore, Journ. Math. Phys. 32 (1991) 332; H. Grosse and J. Madore, Phys. Lett. B283
(1992) 218.
...
\bibitem{akhiez:1965} N. I. Akhiezer,"{\it{The Classical Moment Problem and Some Related Questions in Analysis}}'', Hafner 1965.
...
\bibitem{gwm-4} A. de Goursac, J.-C. Wallet, ''{\it{Symmetries of noncommutative scalar field theory}}'', J.\ Phys.\ A: Math. Theor. {\bf{44}} (2011) 055401, [arxiv:0911.2645]. 
...
\bibitem{vit-wal-12} P. Vitale, J.-C. Wallet, ''{\it{Noncommutative field theories on $\mathbb{R}^3_\lambda$: Toward UV/IR mixing freedom}}'', JHEP {\bf{04}} (2013) 115, [arXiv:1212.5131].
%%CITATION = ARXIV:1212.5131;%%

\bibitem{gvw13} A. G\'er\'e, P. Vitale, J.-C. Wallet, ''{\it{Quantum gauge theories on noncommutative 3-d space}}'', (2013) [arXiv:1312.6145] .
%%CITATION = ARXIV:1312.6145;%%

\bibitem{ARS} A. Y. .Alekseev, A. Recknagel and V. Schomerus, ''{\it{Brane dynamics in background fluxes and
noncommutative geometry}},'' JHEP {\bf{05}} (2000) 010 [hep-th/0003187].

\bibitem{kks} R. Koekoek, P. A.  Lesky, R. F. Swarttouw,"{\it{Hypergeometric orthogonal polynomials and their q-analogues}}" , Springer Monographs in Mathematics, Berlin, New York (2010).

\bibitem{favard} J. Favard, ''{\it{Sur les polyn\^omes de Tchebicheff }}'', C. R. Acad. Sci., Paris {\bf{200}}, 2052 (1935).

\bibitem{stieltjes} T. J. Stieltjes,''{\it{Recherches sur les fractions continues }}, Annales de la facult\'e des Sciences de Toulouse, {\bf{8}}, J.1-122 (1894), {\bf{9}} (1895) A.1-47.

\bibitem{Gszego} G. Szeg\"o, ''{\it{Orthogonal polynomials}}'', 3rd edition, American Mathematical Society, (1974).

\bibitem{bsimon} B. Simon, ''{\it{The classical moment problem as a self-adjoint finite difference operator}}'', Adv. Math. {\bf{137}} (1998) 82.

\bibitem{teschl} G. Teschl, ''{\it{ Jacobi operators and completely integrable nonlinear lattices}}'', Math. Surveys Monographs {\bf{72}}, AMS, 2000.

\bibitem{unboud-jac} J.-C. Wallet, ''{\it{Spectral theorem in noncommutative field theories II: Unbounded Jacobi operators}}'', in preparation.
...
\bibitem{MVW13} P. Martinetti, P. Vitale, J.-C. Wallet, ''{\it{ Noncommutative gauge theories on $\mathbb{R}^2_\theta$ as matrix models}}'', \textit{JHEP} \textbf{09} (2013) 051, [arXiv:1303.7185].
%%CITATION = ARXIV:1303.7185;%%
\bibitem{finite-vol} H. Grosse, R. Wulkenhaar, ''{\it{8D-spectral triple on 4D-Moyal space and the vacuum of noncommutative gauge theory }}'', J. Geom. Phys. {\bf{62}} (2012) 1583. V. Gayral, R. Wulkenhaar, ''{\it{Spectral geometry of the Moyal plane with harmonic propagation}}'', [arxiv:1108.2184].

\bibitem{homot-moyal} J.-C. Wallet, ''{\it{Connes distance by examples: Homothetic spectral metric spaces}}'', Rev. Math. Phys. {\bf{24}} (2012) 1250027, [arxiv:1112.3285]. 
%%CITATION = ARXIV:1112.3285;%%

\bibitem{marseil1} V. Gayral, J. M. Gracia-Bond�a, B. Iochum, T. Sch\"ucker, J. C. Varilly, ''{\it{ Moyal Planes are Spectral Triples}}, Commun. Math. Phys. {\bf{246}} (2004) 569.

\bibitem{moyal1} E. Cagnache, J.-C. Wallet, ''{\it{Spectral Distances: Results for Moyal plane and Noncommutative Torus}}'', SIGMA {\bf{6}} (2010) 026, [arxiv:0912.4185]. 
...
\bibitem{Rieffel} M.A. Rieffel, ''{\it{Metric on state spaces}}'', Doc. Math. {\bf{4}} (1999) 559. M.A. Rieffel, {\it{Compact quantum metric spaces}}'', in: Operator Algebras, Quantization, and Noncommutative Geometry, Contemp. Math., vol. {\bf{365}},
AMS, Providence, RI, (2004) 315.

\bibitem{latrem} F. Latremoliere, ''{\it{Quantum Locally Compact Metric Spaces}}, J.Funct.Anal. {\bf{264}} (2013) 362. 

\bibitem{bel-mar} J. Bellissard, M. Marcolli, K. Reihani, ''{\it{Dynamical systems on Spectral Metric Spaces }}'', arxiv:1008.4617 (2010).

\bibitem{ccs1} A.H. Chamseddine, A. Connes, W. van Suijlekom, ''{\it{Inner Fluctuations in Noncommutative Geometry without the first order condition }}'', J. Geom. Phys. {\bf{73}} (2013) 222.

\bibitem{ccs2} A.H. Chamseddine, A. Connes, W. van Suijlekom, ''{\it{Beyond the Spectral Standard Model: Emergence of Pati-Salam Unification }}'', JHEP {\bf{11}} (2013) 132 .

\bibitem{mdv88} M. Dubois-Violette, ''{\it{D\'erivations et calcul diff\'erentiel non commutatif}}'', C. R. Acad. Sci.
Paris, S\'er. I Math. {\bf{307}} (1988) 403.

\bibitem{mdv99} M. Dubois-Violette, Lectures on graded differential algebras and noncommutative geometry, In {\it{Noncommutative differential geometry and its applications to physics}} (Shonan, 1999), Math. Phys. Stud. 23, Kluwer Acad. Publ., Dordrecht 2001, 245.

\bibitem{WAL1} J.-C. Wallet, ''{\it{Derivations of the Moyal algebra and Noncommutative gauge theories}}'', SIGMA {\bf{5}} (2009) 013, [arXiv:0811.3850].
...
\bibitem{Minwalla} S.~Minwalla, M.~Van Raamsdonk and N.~Seiberg, ''{\it{ Noncommutative perturbative dynamics}},''
...
\bibitem{bgw-13} D.~N. Blaschke, H. Grosse, J.-C. Wallet,''{\it{Slavnov-Taylor identities, non-commutative gauge theories and infrared divergences}}'', JHEP {\bf{06}} (2013) 038 [arXiv:1302.2903].
...
\bibitem{rsw} J.-C. Wallet, \textit{Algebraic setup for the gauge fixing of {BF} and super
...
\bibitem{blasch-stein-10} see D. N. Blaschke, H. Steinacker,''{\it{On the 1-loop effective action for the IKKT model and non-commutative branes}}'', JHEP {\bf{1110}} (2011) 120, [arXiv:1109.3097] and references therein.

\bibitem{Gracia-Bondia:1987kw}  J.~M. Gracia-Bond{\'\i}a and J.~C.
...
\bibitem{helmberg} G. Helmberg, ''{\it{Introduction to spectral theory in Hilbert space }}, North-Holland publishing company, Amsterdam, London (1969).
...
\bibitem{orthop-1} N. Dunford and J. T. Schwartz,''{\it{Linear Operators II: Spectral Theory}}, Interscience 1963.
